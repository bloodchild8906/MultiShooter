...
namespace Visyde
{
    ...
    public class GameManager : MonoBehaviourPunCallbacks, IInRoomCallbacks, IConnectionCallbacks
    {
        ...
        public void SpawnBot(int bot)
        {
            ...
            PlayerController botP = PhotonNetwork.InstantiateRoomObject(playerPrefab, spawnPoint.position, Quaternion.identity, 0, new object[] { bot }).GetComponent<PlayerController>();
        }
